"""lonelygourmet URL Configuration
...
from contents.views import HomeView, MyView, RelationView

admin.site.site_header = "LonelyGourmet Admin"
admin.site.site_title = "LonelyGourmet Admin Site"
admin.site.index_title = "Greeting."
...
urlpatterns = [
    ...
    path('mypage/', MyView.as_view(template_name='mypage.html'), name='mypage'),
